...
export default function ResendVerificationPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('/api/auth/users/resend_verification/', {
        email: email
      });
  ...
  return (
    <div className="flex items-center justify-center py-8 sm:py-12 px-4">
      <div className="max-w-md w-full">
        ...
        {/* Resend Verification Card - Mobile Responsive */}
            ...
            <div className="text-center">
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-500 mb-6">
                  Please check your email inbox and click the verification link. The link will expire in 24 hours.
                </p>
              </div>
